...
public class SSLServerConnection
{
	...
	private static Logger log = Logger.getLogger(SSLServerConnection.class);
	
    private final String DALOGIN = "DALogin=";
    private final String DASTATUS = "da-status=";
    private final String TICKET = "from-PP=";
    private final String SUCCESS = "success";
    private final String KEY_PASSPORT_URLS = "PassportURLs";
    private final String KEY_LOCATION = "Location";
    private final String KEY_AUTHENTICATION_INFO = "Authentication-Info";
    public static final String PASSPORT_LIST_SERVER_ADDRESS = "https://nexus.passport.com/rdr/pprdr.asp";
    private HttpURLConnection httpsConn = null;
     ...
     * exception.
     */
    SSLServerConnection(String strServerAddress)
    {
        ...
        try
        {
            ...
            log.debug(">>> Negotiating challenge with " + PASSPORT_LIST_SERVER_ADDRESS);
    ...
    String getPassportLoginServer()
    {
        ...
        if (httpsConn != null)
        {
            ...
            log.debug("<<< Retrieving passport login server " + strPassportServer);
            httpsConn = null;
    ...
    String requestAuthorizationTicket(String strLoginURL, String strUserName, String strPassword, String strChallenge)
    {
                ...
                (strChallenge != null))
        {
            ...
            try
            {
                ...
                if (strLocation != null)
                {
                    log.debug("<<< Server request redirecting login ");

                    url = new URL(strLocation);

                    log.debug(">>> Redirecting login to " + strLocation);
